...
from sophon.utils import get_file, cache_dir
from sophon.transforms import Compose, Flatten, ToFloat, Normalize
...
class Dataset:
    ...
    def __getitem__(self, index):
        assert np.isscalar(index) # indexはスカラ値だけに対応
        if self.label is None: # 教師なし学習を想定
